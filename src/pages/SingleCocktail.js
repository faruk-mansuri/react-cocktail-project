...
const SingleCocktail = () => {
    ...
    async function getCocktail(){
      try {
        ...
        if(data.drinks){
          ...
          const newCocktail = {
            name, image, info, category, glass, insructions, ingredients
          }
  ...
  const {name, image, category, info, glass, insructions, ingredients} = cocktail;
    ...
    <section className="section cocktail-section">
      ...
      <div className="drink">
        ...
        <div className="drink-info">
          ...
          <p> <span className="drink-data"> insructions: </span> {insructions}</p>
